...
<body>
  <div class="container">
    ...
    Note that this page can take a minute to populate.
    <br><br>
  ...
  <script>
    ...
    document.getElementById('saveBtn').onclick = function () {
      ...
      fetch('/connect', {
        ...
        .catch(e => console.log("Connection change interrupted fetch (expected)", e));
